...
// ----------------------------- GAMESCREENLEVEL1 CLASS ----------------------------- //
class GameScreenLevel1 : GameScreen // Inherits from GameScreen.
{
public:
	/// <summary>
	/// Initialise the first level game screen using a renderer.
	/// </summary>
	explicit GameScreenLevel1(SDL_Renderer* renderer);
