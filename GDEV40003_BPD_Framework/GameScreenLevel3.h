...
// ----------------------------- GAMESCREENLEVEL3 CLASS ----------------------------- //
class GameScreenLevel3 : GameScreen // Inherits from GameScreen.
{
public:
	/// <summary>
	/// Initialise the third level game screen using a renderer.
	/// </summary>
	explicit GameScreenLevel3(SDL_Renderer* renderer);

	/// <summary>
	/// Deletes all of the gameobjects and textures in the scene.
	/// </summary>
	~GameScreenLevel3() override;
